...
class CatheterLocalizationApp:
    ...
    def _build_ui(self):
        ...
        self.s_x = tk.Scale(slider_frame, from_=-0.2, to=0.2, resolution=0.01, label="X", orient=tk.HORIZONTAL, command=self.on_slider)
        self.s_y = tk.Scale(slider_frame, from_=-0.2, to=0.2, resolution=0.01, label="Y", orient=tk.HORIZONTAL, command=self.on_slider)
        self.s_z = tk.Scale(slider_frame, from_=-0.2, to=0.2, resolution=0.01, label="Z", orient=tk.HORIZONTAL, command=self.on_slider)
        self.s_theta = tk.Scale(slider_frame, from_=0, to=2*np.pi, resolution=0.05, label="theta", orient=tk.HORIZONTAL, command=self.on_slider)
        self.s_phi = tk.Scale(slider_frame, from_=0, to=np.pi, resolution=0.05, label="phi", orient=tk.HORIZONTAL, command=self.on_slider)
